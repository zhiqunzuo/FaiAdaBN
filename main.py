...
if __name__ == '__main__':
    ...
    train_set = Fitz17k(dataframe=ann_train, path_to_pickles=train_pkl, sens_name='skin_type', sens_classes=2, transform=transform_train)
    ...
    valid_set = Fitz17k(dataframe=ann_valid, path_to_pickles=valid_pkl, sens_name='skin_type', sens_classes=2, transform=transform)
